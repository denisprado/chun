...
/* harmony import */ var _styles__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./styles */ "./pages/a/styles.js");
...
var Album = function Album(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    __self: this
  }, react_html_parser__WEBPACK_IMPORTED_MODULE_5___default()(album.content)), album.Files ? album.Files.map(function (photo) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            id = context.query.id;
            _context.next = 3;
            return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_4___default()("http://localhost:3333/albums/".concat(id));
...
//# sourceMappingURL=[id].js.b4e30848fd5775756328.hot-update.js.map